...
| Repo | What it is |
|------|-----------|
| [Babel](https://github.com/gthgomez/Babel) | Prompt OS — layered instruction stack for multi-model AI |
| [MonteCarlo-Ledger](https://github.com/gthgomez/MonteCarlo-Ledger) | Personal finance CLI with Monte Carlo risk simulation |
